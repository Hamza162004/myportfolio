...
const Projects = () => {
  return (
    <div className='projects  text-white flex justify-center items-center flex-col'>
        ...
        <div className="pro-con flex justify-center items-center flex-col space-y-10">
            <div className="project w[50rem] flex ml-10 py-2">
                ...
                <div className='w-[40rem] pt-4 pl-28 pr-8 project-des text-center  border-white rounded-3xl border-2'>
                  <h1 className='text-4xl white font-bold '>Notebook Website</h1>
                  ...
                  <div className='flex w-[100%] justify-end '>
                    <a href=""></a><img className='w-10 rounded-full cursor-pointer pb-2' src={git} alt="" />
                  </div>
                </div>
            </div>
             <div className="project w[50rem] flex ml-10 py-2">
                <img className='w-56 h-44 project-img-r' src={p2} alt="" />
                <div className='w-[40rem] pt-4 pr-28 pl-8 project-des text-center  border-white rounded-3xl border-2'>
                  <h1 className='text-4xl white font-bold '>E-commerce Website</h1>
                  <div className='tech-div font-mono flex py-2 font-bold items-center justify-center text-purple-500 space-x-14'>
                      <span>VanillaJS</span>
                      <span>NodeJS</span>
            ...
            <div className="project w[50rem] flex ml-10 py-2">
                ...
                <div className='w-[40rem] pt-4 pl-28 pr-8 project-des text-center  border-white rounded-3xl border-2'>
                  <h1 className='text-4xl white font-bold '>News Website</h1>
                  <div className='tech-div font-mono flex py-2 font-bold items-center justify-center text-purple-500 space-x-14'>
                      <span>ReactJS</span>
                      <span>NodeJS</span>
                      <span>Bootstrap</span>
