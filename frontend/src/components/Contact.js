        ...
        <form className="max-w-sm mx-auto text-left items-center" onSubmit={submit}>
          <div className='my-3 input-con'>
            ...
            <div className="flex">
              ...
              <input onChange={onchange}  value={user.name} type="text" name='name' id="name" className="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Name" />
            </div>
          </div>
          <div className='my-3 input-con'>
            ...
            <div className="flex">
              ...
              <input onChange={onchange} value={user.email} name='email' type="text" id="email" className="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 flex-1 min-w-0 block w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@email.com" />
            </div>
          </div>
